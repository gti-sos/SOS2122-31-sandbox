...
module.exports.register = (app) => {
    ...
    app.put(BASE_API_URL+"/alphabetization-stats/:country/:year",(req, res)=>{
        ...
        if(paramOK(req)){
            ...
            var body = req.body;  
            var tl = alphabetization_stats.filter((reg) =>{
...
//////////////////////////////////////////////////////////////////////
    app.get(BASE_API_URL, (req,res) => {
        ...
        //Añadimos búsqueda:
        if(req.body.country) dbbody["country"]= req.body.country;
		if(req.body.year) dbbody["year"] = parseInt(req.body.year);
		if(req.body.ar_ym) dbbody["ar_ym"] = parseInt(req.body.ar_ym);
		if(req.body.ar_yw) dbbody["ar_yw"] = parseInt(req.body.ar_yw);
		if(req.body.ar_ty) dbbody["ar_ty"] = parseInt(req.body.ar_ty);	
    })
};
